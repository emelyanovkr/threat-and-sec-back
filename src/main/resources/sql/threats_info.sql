create table threats_info
(
    id          bigint not null
        constraint threat_info_pkey
            primary key,
    name        text,
    description text
);

INSERT INTO threat_and_sec_schema.threats_info (id, name, description)
VALUES (87, 'Угроза несанкционированного использования привилегированных функций BIOS', 'Угроза заключается в возможности использования нарушителем потенциально опасных возможностей BIOS/UEFI.
Данная угроза обусловлена наличием в BIOS/UEFI потенциально опасного функционала');
INSERT INTO threat_and_sec_schema.threats_info (id, name, description)
VALUES (1, 'Угроза автоматического распространения вредоносного кода в грид-системе', 'Угроза заключается в возможности внедрения и запуска вредоносного кода от имени доверенного процесса на любом из ресурсных центров грид-системы и его автоматического распространения на все узлы грид-системы.
...
INSERT INTO threat_and_sec_schema.threats_info (id, name, description)
VALUES (2, 'Угроза агрегирования данных, передаваемых в грид-системе', 'Угроза заключается в возможности раскрытия нарушителем защищаемой информации путём выявления задействованных в её обработке узлов, сбора, анализа и обобщения данных, перехватываемых в сети передачи данных грид-системы.
...
INSERT INTO threat_and_sec_schema.threats_info (id, name, description)
VALUES (9, 'Угроза восстановления предыдущей уязвимой версии BIOS', 'Угроза заключается в возможности осуществления вынужденного перехода на использование BIOS/UEFI, содержащей уязвимости.
...
INSERT INTO threat_and_sec_schema.threats_info (id, name, description)
VALUES (10, 'Угроза выхода процесса за пределы виртуальной машины', 'Угроза заключается в возможности запуска вредоносной программой собственного гипервизора, функционирующего по уровню логического взаимодействия ниже компрометируемого гипервизора.
...
INSERT INTO threat_and_sec_schema.threats_info (id, name, description)
VALUES (11, 'Угроза деавторизации санкционированного клиента беспроводной сети', 'Угроза заключается в возможности автоматического разрыва соединения беспроводной точки доступа с санкционированным клиентом беспроводной сети.
...
INSERT INTO threat_and_sec_schema.threats_info (id, name, description)
VALUES (12, 'Угроза деструктивного изменения конфигурации/среды окружения программ', 'Угроза заключается в возможности деструктивного программного воздействия на дискредитируемое приложение путём осуществления манипуляций с используемыми им конфигурационными файлами или библиотеками.
...
INSERT INTO threat_and_sec_schema.threats_info (id, name, description)
VALUES (18, 'Угроза загрузки нештатной операционной системы', 'Угроза заключается в возможности подмены нарушителем загружаемой операционной системы путём несанкционированного переконфигурирования в BIOS/UEFI пути доступа к загрузчику операционной системы.
...
INSERT INTO threat_and_sec_schema.threats_info (id, name, description)
VALUES (21, 'Угроза злоупотребления доверием потребителей облачных услуг', 'Угроза заключается в возможности нарушения (случайно или намеренно) защищённости информации потребителей облачных услуг внутренними нарушителями поставщика облачных услуг.
...
INSERT INTO threat_and_sec_schema.threats_info (id, name, description)
VALUES (24, 'Угроза изменения режимов работы аппаратных элементов компьютера', 'Угроза заключается в возможности изменения нарушителем режимов работы аппаратных элементов компьютера путём несанкционированного переконфигурирования BIOS/UEFI, что позволяет:
...
INSERT INTO threat_and_sec_schema.threats_info (id, name, description)
VALUES (26, 'Угроза искажения XML-схемы', 'Угроза заключается в возможности изменения нарушителем алгоритма обработки информации приложениями, функционирующими на основе XML-схем, вплоть до приведения приложения в состояние "отказ в обслуживании", путём изменения XML-схемы, передаваемой между клиентом и сервером.
...
INSERT INTO threat_and_sec_schema.threats_info (id, name, description)
VALUES (30, 'Угроза использования информации идентификации/аутентификации, заданной по умолчанию', 'Угроза заключается в возможности прохождения нарушителем процедуры авторизации на основе полученной из открытых источников
...
INSERT INTO threat_and_sec_schema.threats_info (id, name, description)
VALUES (32, 'Угроза использования поддельных цифровых подписей BIOS', 'Угроза заключается в возможности установки уязвимой версии обновления BIOS/UEFI или версии, содержащей вредоносное программное обеспечение, но имеющей цифровую подпись.
...
INSERT INTO threat_and_sec_schema.threats_info (id, name, description)
VALUES (35, 'Угроза использования слабых криптографических алгоритмов BIOS', 'Угроза заключается в сложности проверки реальных параметров работы и алгоритмов, реализованных в криптографических средствах BIOS/UEFI. При этом доверие к криптографической защите будет ограничено доверием к производителю BIOS.
...
INSERT INTO threat_and_sec_schema.threats_info (id, name, description)
VALUES (36, 'Угроза исследования механизмов работы программы', 'Угроза заключается в возможности проведения нарушителем обратного инжиниринга кода программы и дальнейшего исследования его структуры, функционала и состава в интересах определения алгоритма работы программы и поиска в ней уязвимостей.
...
INSERT INTO threat_and_sec_schema.threats_info (id, name, description)
VALUES (37, 'Угроза исследования приложения через отчёты об ошибках', 'Угроза заключается в возможности исследования нарушителем алгоритма работы дискредитируемого приложения и его предполагаемой структуры путём анализа генерируемых этим приложением отчётов об ошибках.
...
INSERT INTO threat_and_sec_schema.threats_info (id, name, description)
VALUES (38, 'Угроза исчерпания вычислительных ресурсов хранилища больших данных', 'Угроза заключается в возможности временного возникновения состояния типа «отказ в обслуживании» у хранилища больших данных.
...
INSERT INTO threat_and_sec_schema.threats_info (id, name, description)
VALUES (39, 'Угроза исчерпания запаса ключей, необходимых для обновления BIOS', 'Угроза заключается в возможности нарушения (невозможности осуществления) процедуры обновления BIOS/UEFI при исчерпании запаса необходимых для её проведения ключей.
...
INSERT INTO threat_and_sec_schema.threats_info (id, name, description)
VALUES (40, 'Угроза конфликта юрисдикций различных стран', 'Угроза заключается в возможности отказа в трансграничной передаче защищаемой информации в рамках оказания облачных услуг в соответствии с требованиями локального законодательства стран, резиденты которых участвуют в оказании облачных услуг.
...
INSERT INTO threat_and_sec_schema.threats_info (id, name, description)
VALUES (41, 'Угроза межсайтового скриптинга', 'Угроза заключается в возможности внедрения нарушителем участков вредоносного кода на сайт дискредитируемой системы таким образом, что он будет выполнен на рабочей станции просматривающего этот сайт пользователя.
...
INSERT INTO threat_and_sec_schema.threats_info (id, name, description)
VALUES (43, 'Угроза нарушения доступности облачного сервера', 'Угроза заключается в возможности прекращения оказания облачных услуг всем потребителям (или группе потребителей) из-за нарушения доступности для них облачной инфраструктуры.
...
INSERT INTO threat_and_sec_schema.threats_info (id, name, description)
VALUES (44, 'Угроза нарушения изоляции пользовательских данных внутри виртуальной машины', 'Угроза заключается в возможности нарушения безопасности пользовательских данных программ, функционирующих внутри виртуальной машины, вредоносным программным обеспечением, функционирующим вне виртуальной машины.
...
INSERT INTO threat_and_sec_schema.threats_info (id, name, description)
VALUES (46, 'Угроза нарушения процедуры аутентификации субъектов виртуального информационного взаимодействия', 'Угроза заключается в возможности подмены субъекта виртуального информационного взаимодействия, а также в возможности возникновения состояния неспособности осуществления такого взаимодействия.
...
INSERT INTO threat_and_sec_schema.threats_info (id, name, description)
VALUES (50, 'Угроза неверного определения формата входных данных, поступающих в хранилище больших данных', 'Угроза заключается в возможности искажения информации, сохраняемой в хранилище больших данных, или отказа в проведении сохранения при передаче в него данных в некоторых форматах.
...
INSERT INTO threat_and_sec_schema.threats_info (id, name, description)
VALUES (51, 'Угроза невозможности восстановления сессии работы на ПЭВМ при выводе из промежуточных состояний питания', 'Угроза заключается в возможности потери несохранённых данных, обрабатываемых в предыдущей сессии работы на компьютере, а также в возможности потери времени для возобновления работы на компьютере.
...
INSERT INTO threat_and_sec_schema.threats_info (id, name, description)
VALUES (53, 'Угроза невозможности управления правами пользователей BIOS', 'Угроза заключается в возможности неправомерного использования пользователями декларированного функционала BIOS/UEFI, ориентированного на администраторов.
...
INSERT INTO threat_and_sec_schema.threats_info (id, name, description)
VALUES (56, 'Угроза некачественного переноса инфраструктуры в облако', 'Угроза заключается в возможности снижения реального уровня защищённости иммигрирующей в облако информационной системы из-за ошибок, допущенных при миграции в ходе преобразования её реальной инфраструктуры в облачную.
...
INSERT INTO threat_and_sec_schema.threats_info (id, name, description)
VALUES (57, 'Угроза неконтролируемого копирования данных внутри хранилища больших данных', 'Угроза заключается в сложности контроля за всеми автоматически создаваемыми копиями информации в хранилище больших данных из-за временной несогласованности данных операций.
...
INSERT INTO threat_and_sec_schema.threats_info (id, name, description)
VALUES (60, 'Угроза неконтролируемого уничтожения информации хранилищем больших данных', 'Угроза заключается в возможности удаления из хранилища некоторых обрабатываемых данных без уведомления конечного пользователя или администратора.
...
INSERT INTO threat_and_sec_schema.threats_info (id, name, description)
VALUES (62, 'Угроза некорректного использования прозрачного прокси-сервера за счёт плагинов браузера', 'Угроза заключается в возможности перенаправления или копирования обрабатываемых браузером данных через прозрачный прокси-сервер, подключённый к браузеру в качестве плагина.
...
INSERT INTO threat_and_sec_schema.threats_info (id, name, description)
VALUES (64, 'Угроза некорректной реализации политики лицензирования в облаке', 'Угроза заключается в возможности отказа потребителям облачных услуг в удалённом доступе к арендуемому программному обеспечению (т.е. происходит потеря доступности облачной услуги SaaS) по вине поставщика облачных услуг.
...
INSERT INTO threat_and_sec_schema.threats_info (id, name, description)
VALUES (66, 'Угроза неопределённости ответственности за обеспечение безопасности облака', 'Угроза заключается в возможности невыполнения ряда мер по защите информации как поставщиком облачных услуг, так и их потребителем.
...
INSERT INTO threat_and_sec_schema.threats_info (id, name, description)
VALUES (74, 'Угроза несанкционированного доступа к аутентификационной информации',
...
INSERT INTO threat_and_sec_schema.threats_info (id, name, description)
VALUES (79, 'Угроза несанкционированного доступа к защищаемым виртуальным машинам со стороны других виртуальных машин',
...
INSERT INTO threat_and_sec_schema.threats_info (id, name, description)
VALUES (86, 'Угроза несанкционированного изменения аутентификационной информации', 'Угроза заключается в возможности осуществления неправомерного доступа нарушителем к аутентификационной информации других пользователей с помощью штатных средств операционной системы или специальных программных средств.
...
INSERT INTO threat_and_sec_schema.threats_info (id, name, description)
VALUES (83, 'Угроза несанкционированного доступа к системе по беспроводным каналам', 'Угроза заключается в возможности получения нарушителем доступа к ресурсам всей дискредитируемой информационной системы через используемые в ее составе беспроводные каналы передачи данных.
...
INSERT INTO threat_and_sec_schema.threats_info (id, name, description)
VALUES (92, 'Угроза несанкционированного удалённого внеполосного доступа к аппаратным средствам', 'Угроза заключается в возможности получения нарушителем привилегий управления системой путём использования удалённого внеполосного (по независимому вспомогательному каналу TCP/IP) доступа.
...
INSERT INTO threat_and_sec_schema.threats_info (id, name, description)
VALUES (96, 'Угроза несогласованности политик безопасности элементов облачной инфраструктуры', 'Угроза заключается в возможности осуществления нарушителем деструктивных программных воздействий как в отношении поставщиков, так и потребителей облачных услуг.
...
INSERT INTO threat_and_sec_schema.threats_info (id, name, description)
VALUES (99, 'Угроза обнаружения хостов', 'Угроза заключается в возможности сканирования нарушителем вычислительной сети для выявления работающих сетевых узлов.
...
INSERT INTO threat_and_sec_schema.threats_info (id, name, description)
VALUES (101, 'Угроза общедоступности облачной инфраструктуры', 'Угроза заключается в возможности осуществления несанкционированного доступа к защищаемой информации одного потребителя облачных услуг со стороны другого.
...
INSERT INTO threat_and_sec_schema.threats_info (id, name, description)
VALUES (105, 'Угроза отказа в загрузке входных данных неизвестного формата хранилищем больших данных', 'Угроза заключается в возможности отказа хранилищем больших данных в приёме входных данных неизвестного формата от легального пользователя.
...
INSERT INTO threat_and_sec_schema.threats_info (id, name, description)
VALUES (108, 'Угроза ошибки обновления гипервизора', 'Угроза заключается в возможности дискредитации нарушителем функционирующих на базе гипервизора защитных механизмов, предотвращающих несанкционированный доступ к образам виртуальных машин, из-за ошибок его обновления.
...
INSERT INTO threat_and_sec_schema.threats_info (id, name, description)
VALUES (128, 'Угроза подмены доверенного пользователя', 'Угроза заключается в возможности нарушителя выдавать себя за легитимного пользователя и выполнять приём/передачу данных от его имени. Данную угрозу можно охарактеризовать как «имитация действий клиента».
...
INSERT INTO threat_and_sec_schema.threats_info (id, name, description)
VALUES (123, 'Угроза подбора пароля BIOS', 'Угроза заключается в возможности осуществления нарушителем несанкционированного доступа к настройкам BIOS/UEFI путём входа в консоль BIOS/UEFI по паролю, подобранному программно или «вручную» с помощью методов тотального перебора вариантов или подбора по словарю.
...
INSERT INTO threat_and_sec_schema.threats_info (id, name, description)
VALUES (156, 'Угроза утраты носителей информации', 'Угроза заключается в возможности раскрытия информации, хранящейся на утерянном носителе (в случае отсутствия шифрования данных), или её потери (в случае отсутствия резервной копий данных).
...
INSERT INTO threat_and_sec_schema.threats_info (id, name, description)
VALUES (135, 'Угроза потери и утечки данных, обрабатываемых в облаке', 'Угроза заключается в возможности нарушения конфиденциальности, целостности и доступности защищаемой информации потребителей облачных услуг, обрабатываемой в облачной системе.
...
INSERT INTO threat_and_sec_schema.threats_info (id, name, description)
VALUES (141, 'Угроза привязки к поставщику облачных услуг', 'Угроза заключается в возможности возникновения трудно решаемых (или даже неразрешимых) проблем технического, организационного, юридического или другого характера, препятствующих осуществлению потребителем облачных услуг смены их поставщика.
...
INSERT INTO threat_and_sec_schema.threats_info (id, name, description)
VALUES (144, 'Угроза программного сброса пароля BIOS', 'Угроза заключается в возможности осуществления нарушителем несанкционированного доступа к настройкам BIOS/UEFI после перезагрузки компьютера путём ввода «пустого» пароля.
...
INSERT INTO threat_and_sec_schema.threats_info (id, name, description)
VALUES (147, 'Угроза распространения несанкционированно повышенных прав на всю грид-систему', 'Угроза заключается в возможности автоматического распространения на всю грид-систему несанкционированно полученных нарушителем на одном узле привилегий.
...
INSERT INTO threat_and_sec_schema.threats_info (id, name, description)
VALUES (150, 'Угроза сбоя процесса обновления BIOS', 'Угроза заключается в возможности выведения из строя компьютера из-за внесения критических ошибок в программное обеспечение BIOS/UEFI в результате нарушения процесса его обновления.
Данная угроза обусловлена слабостями технологий контроля за обновлением программного обеспечения BIOS/UEFI.
...
INSERT INTO threat_and_sec_schema.threats_info (id, name, description)
VALUES (151, 'Угроза сканирования веб-сервисов, разработанных на основе языка описания WSDL', 'Угроза заключается в возможности получения нарушителем сведений о текущей конфигурации веб-служб и наличии в ней уязвимостей путём исследования WSDL-интерфейса веб-сервера.
...
INSERT INTO threat_and_sec_schema.threats_info (id, name, description)
VALUES (158, 'Угроза форматирования носителей информации', 'Угроза заключается в возможности утраты хранящейся на форматируемом носителе информации, зачастую без возможности её восстановления, из-за преднамеренного или случайного выполнения процедуры форматирования носителя информации.
...
INSERT INTO threat_and_sec_schema.threats_info (id, name, description)
VALUES (159, 'Угроза «форсированного веб-браузинга»', 'Угроза заключается в возможности получения нарушителем доступа к защищаемой информации, выполнения привилегированных операций или осуществления иных деструктивных воздействий на некорректно защищённые компоненты веб-приложений.
...
INSERT INTO threat_and_sec_schema.threats_info (id, name, description)
VALUES (191, 'Угроза внедрения вредоносного кода в дистрибутив программного обеспечения',
...
INSERT INTO threat_and_sec_schema.threats_info (id, name, description)
VALUES (169, 'Угроза наличия механизмов разработчика', 'Угроза заключается в возможности перехвата управления программой за счёт использования отладочных механизмов (специальных программных функций или аппаратных элементов, помогающих проводить тестирование и отладку средств во время их разработки).
...
INSERT INTO threat_and_sec_schema.threats_info (id, name, description)
VALUES (170, 'Угроза неправомерного шифрования информации', 'Угроза заключается в возможности фактической потери доступности защищаемых данных из-за их несанкционированного криптографического преобразования нарушителем с помощью известного только ему секретного ключа.
...
INSERT INTO threat_and_sec_schema.threats_info (id, name, description)
VALUES (173, 'Угроза «спама» веб-сервера', 'Угроза заключается в возможности неправомерного осуществления нарушителем массовой рассылки коммерческих, политических, мошеннических и иных сообщений на веб-сервер без запроса со стороны дискредитируемых веб-серверов.
...
INSERT INTO threat_and_sec_schema.threats_info (id, name, description)
VALUES (185, 'Угроза несанкционированного изменения параметров настройки средств защиты информации',
...
INSERT INTO threat_and_sec_schema.threats_info (id, name, description)
VALUES (189, 'Угроза маскирования действий вредоносного кода', 'Угроза заключается в возможности сокрытия в системе действий вредоносного кода за счет применения специальных механизмов маскирования кода (архивирование, изменение формата данных и др.), которые препятствуют его дальнейшему анализу.
...
INSERT INTO threat_and_sec_schema.threats_info (id, name, description)
VALUES (196, 'Угроза контроля вредоносной программой списка приложений, запущенных на мобильном устройстве', 'Угроза заключается в возможности использования вредоносной программы для контроля списка приложений, запущенных на мобильном устройстве.
...
INSERT INTO threat_and_sec_schema.threats_info (id, name, description)
VALUES (200, 'Угроза хищения информации с мобильного устройства при использовании виртуальных голосовых ассистентов', 'Угроза заключается в возможности хищения данных пользователя с его мобильного устройства через виртуальных голосовых ассистентов (например, через Siri для IPhone).
...
INSERT INTO threat_and_sec_schema.threats_info (id, name, description)
VALUES (206, 'Угроза отказа в работе оборудования из-за изменения геолокационной информации о нем',
...
INSERT INTO threat_and_sec_schema.threats_info (id, name, description)
VALUES (208, 'Угроза нецелевого использования вычислительных ресурсов средства вычислительной техники', 'Угроза заключается в возможности использования вычислительных ресурсов средств вычислительной техники для осуществления сторонних вычислительных процессов.
...
INSERT INTO threat_and_sec_schema.threats_info (id, name, description)
VALUES (209, 'Угроза несанкционированного доступа к защищаемой памяти
...
INSERT INTO threat_and_sec_schema.threats_info (id, name, description)
VALUES (213, 'Угроза обхода многофакторной аутентификации', 'Угроза заключается в возможности обхода многофакторной аутентификации путем внедрения вредоносного кода в дискредитируемую систему и компоненты, участвующие в процедуре многофакторной аутентификации.
Данная угроза обусловлена:
наличием уязвимостей программного обеспечения;
слабостями мер антивирусной защиты и разграничения доступа.
Реализация данной угрозы возможна:
...
INSERT INTO threat_and_sec_schema.threats_info (id, name, description)
VALUES (217, 'Угроза использования скомпрометированного доверенного источника обновлений программного обеспечения', 'Угроза заключается в возможности внедрения вредоносного кода в информационную систему за счет использования скомпрометированных доверенных источников обновлений программного обеспечения.
...
INSERT INTO threat_and_sec_schema.threats_info (id, name, description)
VALUES (218, 'Угроза раскрытия информации о модели машинного обучения', 'Угроза заключается в возможности раскрытия нарушителем информации о модели машинного обучения, используемой в информационной (автоматизированной) системе.
...
INSERT INTO threat_and_sec_schema.threats_info (id, name, description)
VALUES (219, 'Угроза хищения обучающих данных', 'Угроза заключается в возможности хищения нарушителем обучающих данных, используемых в информационной (автоматизированной) системе, реализующей технологии искусственного интеллекта.
...
INSERT INTO threat_and_sec_schema.threats_info (id, name, description)
VALUES (220, 'Угроза нарушения функционирования («обхода») средств, реализующих технологии искусственного интеллекта', 'Угроза заключается в возможности нарушения функционирования («обхода») нарушителем средств, реализующих технологии искусственного интеллекта.
...
INSERT INTO threat_and_sec_schema.threats_info (id, name, description)
VALUES (221, 'Угроза модификации модели машинного обучения путем искажения («отравления») обучающих данных', 'Угроза заключается в возможности модификации (искажения) модели машинного обучения, используемой в информационной (автоматизированной) системе, реализующей технологии искусственного интеллекта.
Данная угроза обусловлена:
...
INSERT INTO threat_and_sec_schema.threats_info (id, name, description)
VALUES (222, 'Угроза подмены модели машинного обучения', 'Угроза заключается в возможности подмены нарушителем модели машинного обучения, используемой в информационной (автоматизированной) системе, реализующей технологии искусственного интеллекта.
Данная угроза обусловлена слабостями разграничения доступа в информационных (автоматизированных) системах, использующих машинное обучение.
Реализация данной угрозы возможна при наличии у нарушителя непосредственного доступа к модели машинного обучения');
